          ...
          APP: Component<MSG> + 'static
{
    ...
    /// Fetch from the url with decoder for the text response and the fail callback
    pub fn fetch_with_text_response_decoder<DE, CB, ERR, OUT>(self: &Rc<Self>,
                                                              url: &str,
                                                              response_text_decoder: DE,
                                                              cb: CB,
                                                              fail_cb: ERR)
        where CB: Fn(OUT) -> MSG + 'static,
              ...
              OUT: 'static
    {
        let response_decoder = move |js_value: JsValue| {
            ...
            let grouped_window = response_text_decoder(response_text);
            cb(grouped_window)
        };
    ...
    pub fn fetch_with_response_decoder<F, ERR>(self: &Rc<Self>,
                                               url: &str,
                                               response_decoder: F,
                                               fail_cb: ERR)
              ...
              ERR: Fn(JsValue) -> MSG + Clone + 'static
    {
        ...
        let program_clone_status_err = Rc::clone(self);
        ...
        let program_clone_response_error = Rc::clone(self);
