              ...
              text {
                ...
                rect!(
                    [
                        width(800),
                        height(460),
                        html::attributes::style("fill: url(#gradient-1);")
                    ],
                    []
                ),
                rect!(
                    [
                        ...
                        height(360),
                        html::attributes::style(
                            "fill: url(#pattern-2); fill-opacity: 0.2; stroke: rgb(105, 105, 104);"
                        )
                    ],
                    []
                ),
                svg::tags::text(
                    vec![
                        ...
                        y(36.8),
                        html::attributes::style(
                            "font-size: 16px; font-family: Roboto; fill: rgb(251, 251, 251); word-spacing: 0px;"
                        )
                    ],
                    vec![text!(
                ...
                path!(
                    [
                        ...
                        html::attributes::style(
                            "stroke: rgb(253, 200, 39); vector-effect:non-scaling-stroke; stroke-width: 3; fill: none;"
                        ),
                ...
                path!(
                    [
                        ...
                        html::attributes::style(
                            "stroke: rgb(33, 125, 245); vector-effect: non-scaling-stroke; fill: none; stroke-width: 3;"
                        ),
                        attr("bx:origin", "0.5 0.5")
                    ],
                    []
